package com.mac.ui_library.titlebar;
...
import com.mac.ui_library.titlebar.style.BaseTitleBarStyle;
import com.mac.ui_library.titlebar.style.TitleBarLightStyle;
import com.mac.ui_library.titlebar.style.TitleBarNightStyle;
import com.mac.ui_library.titlebar.style.TitleBarRippleStyle;
import com.mac.ui_library.titlebar.style.TitleBarTransparentStyle;
...
public final class TitleBar extends FrameLayout
    ...
    private TextView mLeftView, mTitleView, mFirstRightView,mSecondRightView;
    ...
    private void initView(Context context) {
        ...
        mFirstRightView = ViewBuilder.newRightView(context);
        mSecondRightView = ViewBuilder.newRightView(context);

        mLeftView.setEnabled(false);
        mTitleView.setEnabled(false);
        mFirstRightView.setEnabled(false);
        mSecondRightView.setEnabled(false);
    }
    ...
    private void initStyle(AttributeSet attrs) {
        ...
        if (array.hasValue(R.styleable.TitleBar_firstRightTitle)) {
            setFirstRightTitle(array.getString(R.styleable.TitleBar_firstRightTitle));
        }
        if (array.hasValue(R.styleable.TitleBar_secondRightTitle)) {
            setSecondRightTitle(array.getString(R.styleable.TitleBar_secondRightTitle));
        }
        ...
        if (array.hasValue(R.styleable.TitleBar_firstRightIcon)) {
            setFirstRightIcon(ViewBuilder.getDrawable(getContext(), array.getResourceId(R.styleable.TitleBar_firstRightIcon, 0)));
        }
        if (array.hasValue(R.styleable.TitleBar_secondRightIcon)) {
            setSecondRightIcon(ViewBuilder.getDrawable(getContext(), array.getResourceId(R.styleable.TitleBar_secondRightIcon, 0)));
        }
        ...
        setFirstRightColor(array.getColor(R.styleable.TitleBar_firstRightColor, mCurrentStyle.getFirstRightColor()));
        setSecondRightColor(array.getColor(R.styleable.TitleBar_secondRightColor, mCurrentStyle.getSecondRightColor()));
        ...
        setFirstRightSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.TitleBar_firstRightSize, (int) mCurrentStyle.getFirstRightSize()));
        setSecondRightSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.TitleBar_secondRightSize, (int) mCurrentStyle.getSecondRightSize()));
        ...
        if (array.hasValue(R.styleable.TitleBar_firstRightBackground)) {
            setFirstRightBackground(array.getDrawable(R.styleable.TitleBar_firstRightBackground));
        }else {
            setFirstRightBackground(mCurrentStyle.getFirstRightBackground());
        }

        if (array.hasValue(R.styleable.TitleBar_secondRightBackground)) {
            setSecondRightBackground(array.getDrawable(R.styleable.TitleBar_secondRightBackground));
        }else {
            setSecondRightBackground(mCurrentStyle.getSecondRightBackground());
        }
    ...
    private void initBar() {
        ...
        mMainLayout.addView(mFirstRightView);
        mMainLayout.addView(mSecondRightView);
    ...
    public void run() {
        ...
        if ((mTitleView.getGravity() & Gravity.CENTER_HORIZONTAL) != 0) {
            ...
            final int rightSize = mSecondRightView.getWidth();
        ...
        mFirstRightView.setEnabled(ViewBuilder.hasTextViewContent(mFirstRightView));
        mSecondRightView.setEnabled(ViewBuilder.hasTextViewContent(mSecondRightView));
    }
    ...
    public void onClick(View v) {
        ...
        } else if (v == mFirstRightView) {
            mListener.onFirstRightClick(v);
        }else if (v==mSecondRightView){
            mListener.onSecondRightClick(v);
    ...
    public TitleBar setOnTitleBarListener(OnTitleBarListener l) {
        ...
        mFirstRightView.setOnClickListener(this);
        mSecondRightView.setOnClickListener(this);
        return this;
    }
     ...
     * 右边1的标题
     */
    public TitleBar setFirstRightTitle(@StringRes int id) {
        return setFirstRightTitle(getResources().getString(id));
    }
    /**
     * 右边2的标题
     */
    public TitleBar setSecondRightTitle(@StringRes int id) {
        return setSecondRightTitle(getResources().getString(id));
    }
    public TitleBar setFirstRightTitle(CharSequence text) {
        mFirstRightView.setText(text);
        post(this);
        return this;
    }
    public TitleBar setSecondRightTitle(CharSequence text) {
        mSecondRightView.setText(text);
        post(this);
        return this;
    }

    public CharSequence getFirstRightTitle() {
        return mFirstRightView.getText();
    }
    public CharSequence getSecondRightTitle() {
        return mSecondRightView.getText();
    }
     ...
     * 设置右边1的图标
     */
    public TitleBar setFirstRightIcon(@DrawableRes int id) {
        return setFirstRightIcon(ViewBuilder.getDrawable(getContext(), id));
    }
    /**
     * 设置右边2的图标
     */
    public TitleBar setSecondRightIcon(@DrawableRes int id) {
        return setSecondRightIcon(ViewBuilder.getDrawable(getContext(), id));
    }

    public TitleBar setFirstRightIcon(Drawable drawable) {
        mFirstRightView.setCompoundDrawablesWithIntrinsicBounds(null, null, drawable, null);
        post(this);
        return this;
    }
    public TitleBar setSecondRightIcon(Drawable drawable) {
        mSecondRightView.setCompoundDrawablesWithIntrinsicBounds(null, null, drawable, null);
        post(this);
        return this;
    }
    ...
    public Drawable getFirstRightIcon() {
        return mFirstRightView.getCompoundDrawables()[2];
    }
    public Drawable getSecondRightIcon() {
        return mSecondRightView.getCompoundDrawables()[2];
    }
     ...
     * 设置右1标题颜色
     */
    public TitleBar setFirstRightColor(int color) {
        mFirstRightView.setTextColor(color);
        return this;
    }
    /**
     * 设置右2标题颜色
     */
    public TitleBar setSecondRightColor(int color) {
        mSecondRightView.setTextColor(color);
        return this;
    }
     ...
     * 设置右1标题状态选择器
     */
    public TitleBar setFirstRightBackground(@DrawableRes int id) {
        return setFirstRightBackground(ViewBuilder.getDrawable(getContext(), id));
    }
    /**
     * 设置右2标题状态选择器
     */
    public TitleBar setSecondRightBackground(@DrawableRes int id) {
        return setSecondRightBackground(ViewBuilder.getDrawable(getContext(), id));
    }

    public TitleBar setFirstRightBackground(Drawable drawable) {
        ViewBuilder.setBackground(mFirstRightView, drawable);
        post(this);
        return this;
    }
    public TitleBar setSecondRightBackground(Drawable drawable) {
        ViewBuilder.setBackground(mSecondRightView, drawable);
        post(this);
        return this;
    }
     ...
     * 设置右标题的文本大小
     */
    public TitleBar setFirstRightSize(int unit, float size) {
        mFirstRightView.setTextSize(unit, size);
        post(this);
        return this;
    }
    /**
     * 设置右标题的文本大小
     */
    public TitleBar setSecondRightSize(int unit, float size) {
        mSecondRightView.setTextSize(unit, size);
        post(this);
        return this;
    }
    ...
    public TitleBar setDrawablePadding(int px) {
        ...
        mFirstRightView.setCompoundDrawablePadding(px);
        mSecondRightView.setCompoundDrawablePadding(px);
        post(this);
        return this;
    }
    ...
    public TitleBar setChildPadding(int px) {
        ...
        mFirstRightView.setPadding(px, 0, px, 0);
        mSecondRightView.setPadding(px, 0, px, 0);
        post(this);
        return this;
    }
    ...
    public TextView getFirstRightView() {
        return mFirstRightView;
    }

    public TextView getSencedRightView() {
        return mSecondRightView;
    }

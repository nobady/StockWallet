...
public interface ITitleBarStyle {
    ...
    int getFirstRightColor(); // 右边文本颜色
    int getSecondRightColor(); // 右边文本颜色

    float getLeftSize(); // 左边文本大小
    float getTitleSize(); // 标题文本大小
    float getFirstRightSize(); // 右边文本大小
    float getSecondRightSize(); // 右边文本大小
    ...
    Drawable getFirstRightBackground(); // 右边背景资源
    Drawable getSecondRightBackground(); // 右边背景资源
}